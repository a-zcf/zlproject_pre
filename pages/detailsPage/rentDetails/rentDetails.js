...
Page({
  ...
  getHouseDetail({id}) {
    ...
    request({
      ...
      realSuccess: function(data) {
        ...
        let { describes, introductionDetail, title, lat, lng } = rentDetails;
        // if (describes != ''){
  ...
  moreInformation: function(e) {
    let rentId = e.currentTarget.dataset.id;
    let describes = e.currentTarget.dataset.describes;
    wx.navigateTo({
      url: '../moreInformation/moreInformation?id=' + rentId + '&describes=' + describes
    })
  },
  // 关注、取消关注
  follow: function(e) {
  ...
  onShareAppMessage: function(e) {
    ...
    return {
      title: '分享',
      path: 'pages/detailsPage/rentDetails/rentDetails?id=' + fxId,
