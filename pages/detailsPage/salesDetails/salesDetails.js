...
Page({
  ...
  moreInformation: function (e) {
    ...
    wx.navigateTo({
      url: '../moreInformation/moreInformation?id=' + this.data.posId + '&describes=' + describes
    })
  },
  //大众点评信息
  comment: function (e) {
    ...
    wx.navigateTo({
      url: '../comment/comment?id=' + this.data.posId + '&baseservicer=' + baseservicer
    })
  },
  // 关注、取消关注
  follow: function (e) {
  ...
  getHouseDetail({id}) {
    ...
    request({
      ...
      // 获取特价房源列表数据
      realSuccess: function (data) {
        let salesDetailsList = data.data;
        ...
        let {introductionDetail, baseServicer, lat, lng } = salesDetailsList;
        // if (desc.lent != ''){
  ...
  onShareAppMessage: function (e) {
    ...
    return {
      title: '分享',
      path: 'pages/detailsPage/salesDetails/salesDetails?id=' + fxId,
